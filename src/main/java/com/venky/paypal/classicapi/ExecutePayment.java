...
public class ExecutePayment {
	...
	public static void main(String[] args) throws ServletException, IOException {
		ExecutePayment pay = new ExecutePayment();
		pay.executePayment();
	}
	...
	public ExecutePaymentResponse executePayment() {
		...
		ExecutePaymentRequest executePaymentRequest = new ExecutePaymentRequest(
				requestEnvelope, "AP-1US73684V8049553N");
		...
		try {
			service = new AdaptivePaymentsService(ExecutePayment.class.getResourceAsStream("sdk_config.properties"));
		} catch (IOException e) {
